# Prepare for CRAN ----
# Found on: https://github.com/ThinkR-open/prepare-for-cran
...
# If you used parallel testing, you may need to avoid it for the next check with
# `Config/testthat/parallel: false` in DESCRIPTION
all_files_remaining <- checkhelper::check_clean_userspace()
all_files_remaining
# If needed, set back parallel testing with `Config/testthat/parallel: true` in
# DESCRIPTION
